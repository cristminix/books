...
![Figure 2.1](Images/2-1.png "The difference between generative and predictive models")
...
![Figure 2.2](Images/2-2.png "The main elements that describe an LLM")
...
![Figure 2.3](Images/2-3.png "LM Studio software showing the main home page")
...
![Figure 2.4](Images/2-4.png "The LM Studio search page")
...
![Figure 2.5](Images/2-5.png "The LM Studio chat page with a loaded, locally running LLM")
...
![Figure 2.6](Images/2-6.png "The LM Studio server page and a server running an LLM")
...
![Figure 2.7](Images/2-7.png "Choosing the correct Server Model Settings for the loaded model")
...
![Figure 2.8](Images/2-8.png "OpenAI prompt engineering strategies reviewed in this book, by chapter location")
...
![Figure 2.9](Images/2-9.png "The tactics for the Write Clear Instructions strategy")
...
![Figure 2.10](Images/2-10.png "The output of the prompt engineering tactics tester")
...
![Figure 2.11](Images/2-11.png "The important criteria to consider when consuming an LLM")
