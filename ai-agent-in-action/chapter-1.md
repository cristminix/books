...
![Figure 1.1](Images/1-1.png "The differences between the LLM interactions from direct action compared to using proxy agents, agents, and autonomous agents")
...
![Figure 1.2](Images/1-2.png "In this example of a multi-agent system, the controller or agent proxy communicates directly with the user. Two agents—a coder and a tester—work in the background to create code and write unit tests to test the code.")
...
![Figure 1.3](Images/1-3.png "The five main components of a single-agent system (image generated through DALL-E 3)")
...
![Figure 1.4](Images/1-4.png "An in-depth look at how we'll explore creating agent profiles")
...
![Figure 1.5](Images/1-5.png "The aspects of agent actions we'll explore in this book")
...
![Figure 1.6](Images/1-6.png "Exploring the role and use of agent memory and knowledge")
...
![Figure 1.7](Images/1-7.png "The reasoning and evaluation component and details")
...
![Figure 1.8](Images/1-8.png "Exploring the role of agent planning and reasoning")
...
![Figure 1.9](Images/1-9.png "The original design of the AutoGPT agent system")
...
![Figure 1.10](Images/1-10.png "A vision of how agents will interact with software systems")
