...
(see~\Cref{tab:example_simulated_dialogue} and~\Cref{tab:example_simulated_dialogue_repetitive_ending}).
...
Full linguistic results are provided in \Cref{tab:dialogue_simulation_linguistic_all_results}.
