...
![Figure 3.1](Images/3-1.png "The main interface to the GPT Store")
...
![Figure 3.2](Images/3-2.png "Interacting with the GPT Builder to create an assistant")
...
![Figure 3.3](Images/3-3.png "The Configure panel of the GPT Assistants platform interface")
...
![Figure 3.4](Images/3-4.png "The output results of the Culinary Companion GPT")
...
![Figure 3.5](Images/3-5.png "Turning on the Code Interpreter tool/skill")
...
![Figure 3.6](Images/3-6.png "The output generated by the assistant as it analyzed the CSV data")
...
![Figure 3.7](Images/3-7.png "Navigating the Swagger docs and getting the openapi.json document")
...
![Figure 3.8](Images/3-8.png "Adding a new custom action")
...
![Figure 3.9](Images/3-9.png "Testing the API service endpoint is correctly configured as a custom action")
...
![Figure 3.10](Images/3-10.png "Adding files to the assistant's knowledge")
...
![Figure 3.11](Images/3-11.png "Output from asking the GPT to teach calculus")
...
![Figure 3.12](Images/3-12.png "Uploading documents to the assistant's knowledge")
...
|----------|----------------|---------|
| Search | Search for this phrase in your knowledge: "the robot servant." | Returns the document and an excerpt |
| Compare | Identify the three most similar books that share the same writing style. | Returns the three most similar documents |
...
| Generation | Generate a fictional paragraph that mimics your knowledge of the robot servant. | Generates new content based on its knowledge base |
...
![Figure 3.13](Images/3-13.png "GPT sharing options")
...
![Figure 3.14](Images/3-14.png "Selecting the options after clicking Save to publish to the GPT Store")
